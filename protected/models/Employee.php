...
class Employee extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('usertype, company_id, language_id, is_active, tshirt_size_id, jersey_size_id, trousers_size_id, boots_size_id, coat_size_id', 'numerical', 'integerOnly'=>true),
			array('name, surname', 'length', 'max'=>255),
			array('password, phone', 'length', 'max'=>512),
			array('username', 'length', 'max'=>256),
			array('address, started', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, name, surname, address, password, username, usertype, phone, started, company_id, language_id, is_active, tshirt_size_id, jersey_size_id, trousers_size_id, boots_size_id, coat_size_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'company_id' => 'Įmonė',
			'language_id' => 'Kalba',
			'is_active' => 'Vartotojas aktyvuotas',
			'tshirt_size_id' => 'Marškinėlių dydis',
			'jersey_size_id' => 'Megztinio dydis',
			'trousers_size_id' => 'Kelnių dydis',
			'boots_size_id' => 'Batų dydis',
			'coat_size_id' => 'Striukės dydis',
		);
	}
