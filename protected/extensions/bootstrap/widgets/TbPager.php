...
class TbPager extends CLinkPager
{
    ...
    protected function createPageButtons()
    {
        ...
        $buttons[] = $this->createPageButton($this->prevPageLabel, $page, 'previous paginate_button paginate_button_disabled', $currentPage <= 0, false);
    ...
    {
        if ($hidden || $selected)
            $class .= ' ' . ($hidden ? 'paginate_button' : 'paginate_active');
